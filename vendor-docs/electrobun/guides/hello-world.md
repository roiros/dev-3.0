...
If you'd prefer to be up and running in seconds we offer starter templates including a `hello-world`, `photo-booth`, and multi-tabbed `web-browser`. If you have bun installed and want to get started in a few clicks, just run:

```bash
bunx electrobun init
```

and choose the starter template you want to explore.
