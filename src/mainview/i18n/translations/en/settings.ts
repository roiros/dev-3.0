const settings = {
	...
	"projectSettings.aiReviewDesc": "Automatically run a review agent after the primary agent finishes. The reviewer checks for bugs, code reuse issues, and fixes them.",
