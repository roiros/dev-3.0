const settings = {
	...
	"projectSettings.aiReviewDesc": "Автоматически запускать ревью-агента после завершения работы основного агента. Ревьюер ищет баги, проблемы с повторным использованием кода и исправляет их.",
