const tips = {
	...
	"tip.dragColumns.title": "Поменяйте порядок колонок",
	"tip.dragColumns.body": "Схватите ручку в заголовке кастомной колонки и перетащите её, чтобы изменить порядок на доске.",
