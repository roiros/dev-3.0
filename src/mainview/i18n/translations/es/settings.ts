const settings = {
	...
	"projectSettings.aiReviewDesc": "Ejecutar automáticamente un agente de revisión después de que el agente principal termine. El revisor busca errores, problemas de reutilización de código y los corrige.",
