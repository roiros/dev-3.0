...
const SKILL_CONTENT = `---
name: dev3
description: "MANDATORY when .dev3-marker file exists in the working directory. This means you are inside a dev-3.0 managed worktree with a Kanban task assigned to you. You MUST invoke this skill at the very start of every session — before doing any other work. Failure to invoke is a protocol violation. After completing all work, you MUST update the task status (review-by-user, user-questions, or in-progress)."
allowed-tools: Bash
user-invocable: true
---
